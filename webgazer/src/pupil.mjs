import blinkDetector from "./blinkDetector.mjs";
...
const getPupils = function(eyesObj) {
  ...
  // console.log(`eyes blink: ${eyesObj.left.blink} - ${eyesObj.right.blink}`);
  if (!eyesObj.left.blink) {
    eyesObj.left.pupil = getSinglePupil(Array.prototype.slice.call(util.grayscale(eyesObj.left.patch.data, eyesObj.left.width, eyesObj.left.height)), eyesObj.left.width, eyesObj.left.height);
    eyesObj.left.pupil[0][0] -= eyesObj.left.pupil[1];
    eyesObj.left.pupil[0][1] -= eyesObj.left.pupil[1];
  }
  if (!eyesObj.right.blink) {
    eyesObj.right.pupil = getSinglePupil(Array.prototype.slice.call(util.grayscale(eyesObj.right.patch.data, eyesObj.right.width, eyesObj.right.height)), eyesObj.right.width, eyesObj.right.height);
    eyesObj.right.pupil[0][0] -= eyesObj.right.pupil[1];
    eyesObj.right.pupil[0][1] -= eyesObj.right.pupil[1];
  }
  eyesObj = blinkDetector.detectBlink(eyesObj);
  return eyesObj;
}
