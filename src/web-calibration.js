    ...
    return (
      <div className="test">
        ...
        <nav id="webgazerNavbar" className="navbar navbar-default navbar-fixed-top">
          <div className="collapse navbar-collapse" id="myNavbar">
            <ul className="nav navbar-nav">
              ...
              <li><button>Recalibrate</button></li>
              <li><button>Toggle Kalman Filter</button></li>
            </ul>
            <ul className="nav navbar-nav navbar-right">
              <li>
                <button className="helpBtn" data-toggle="modal" data-target="#helpModal">
                  <a data-toggle="modal"><span className="glyphicon glyphicon-cog"></span> Help</a>
                </button>
              </li>
            </ul>
          </div>
        ...
        <div className="calibrationDiv">
          <button className="calibration" id="Pt1" onClick={this.test("Pt1")}></button>
          <input type="button" className="calibration" id="Pt2" onClick={this.test("Pt2")}></input>
          <input type="button" className="calibration" id="Pt3" onClick={this.test("Pt3")}></input>
          <input type="button" className="calibration" id="Pt4" onClick={this.test("Pt4")}></input>
          <input type="button" className="calibration" id="Pt5" onClick={this.test("Pt5")}></input>
          <input type="button" className="calibration" id="Pt6" onClick={this.test("Pt6")}></input>
          <input type="button" className="calibration" id="Pt7" onClick={this.test("Pt7")}></input>
          <input type="button" className="calibration" id="Pt8" onClick={this.test("Pt8")}></input>
          <input type="button" className="calibration" id="Pt9" onClick={this.test("Pt9")}></input>
        </div>
        <Button variant="primary" onClick={this.onClickButton} style={{ visibility: 'hidden' }}>
          Launch static backdrop modal
        </Button>
        <Modal show={this.state.openModal} onClose={this.onCloseModal} backdrop="static">
          <Modal.Body>
            <div className="modal-body">
              <img src={Image} width="100%" height="100%" alt="webgazer demo instructions"></img>
            </div>
          </Modal.Body>
          <Modal.Footer>
            <div className="modal-footer">
              <Button variant="secondary" onClick={this.onCloseModal}>Close & load saved model</Button>
              <Button variant="primary" onClick={this.Restart}>Calibration</Button>
            </div>
          </Modal.Footer>
        </Modal>
      </div>
